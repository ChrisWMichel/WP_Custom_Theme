...
function custom_plus_render_auth_modal_cb( $attributes ) {
    ...
    <div class="wp-block-udemy-plus-auth-modal">
        <div class="modal-container">
            ...
            <ul class="tabs">
                ...
                <?php
                    if ( ! empty( $attributes['showRegister'] ) ) {
                        ?>
                        <!-- Register Tab -->
                        <li>
                        <a href="#signup-tab">
            ...
            <div class="modal-body">
                <!-- Login Form -->
                <form id="signin-tab" class="signin-form" style="display: block;">
                ...
                <!-- Register Form -->
                 <?php
                    if ( ! empty( $attributes['showRegister'] ) ) {
                        ?>
                        <form id="signup-tab" class="signup-form" style="display: none;">
